...
- Hosted mode: real API keys via `dashboard-aggregator`
...
| Hosted | real `nmcp_*` (core) or `ncmcp_*` (compute) keys | credit ledger via dashboard-aggregator | Aurora + retention |
