/**
 * NovoMCP Molecule Viewer - MCP App Wrapper
 *
 * Handles MCP App connection and passes props to the viewer component.
 */
...
function McpAppWrapper() {
  ...
  const { app, error } = useApp({
    appInfo: { name: "NovoMCP Molecule Viewer", version: "1.0.0" },
    capabilities: {},
    onAppCreated: (app) => {
