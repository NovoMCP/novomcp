...
from novomcp.routers.scheduled_tasks import router as scheduled_tasks_router
from novomcp.routers.service_health import router as service_health_router

# MCP (Model Context Protocol) router for NovoMCP
from novomcp.mcp.router import router as mcp_router, v1_router as mcp_v1_router, setup_mcp
from novomcp.mcp.agent_endpoint import agent_router as mcp_agent_router
from novomcp.mcp.events_endpoint import events_router as mcp_events_router, event_stream_manager
from novomcp.mcp.llm_admin import llm_admin_router as mcp_llm_admin_router
...
async def lifespan(app: FastAPI):
    ...
    from novomcp.core.secrets import require_secret
    ...
    try:
        from novomcp.core.updater import log_update_status_on_boot
    ...
    if REDIS_URL and settings.REDIS_ENABLE_PUBSUB:
        try:
            from novomcp.core.redis_pubsub import RedisPubSubManager
            import novomcp.core.redis_pubsub as redis_pubsub_module
    ...
    try:
        from novomcp.mcp.tool_search import build_index as _build_tool_search_index
...
# Trusts managed backend and DB-Manager to work with DBSchema-Manager
...
async def get_pdb_cache_stats():
    ...
    from novomcp.utils.pdb_cache import get_cache_stats
...
async def clear_pdb_cache_endpoint():
    ...
    from novomcp.utils.pdb_cache import clear_pdb_cache
...
async def invalidate_pdb_endpoint(pdb_id: str):
    ...
    from novomcp.utils.pdb_cache import invalidate_pdb
...
async def get_pdb_metadata_endpoint(pdb_id: str):
    ...
    from novomcp.utils.pdb_cache import get_structure_metadata
